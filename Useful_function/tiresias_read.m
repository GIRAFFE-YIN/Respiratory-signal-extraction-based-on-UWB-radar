function [raw_data_A,raw_data_12,raw_data_C] = tiresias_read(webpage)
...
% raw_data_12 = a2{1,1};
raw_data_A = raw_data_A(20:end);
raw_data_12 = raw_data_12(20:end);
raw_data_C = raw_data_C(20:end);
end
